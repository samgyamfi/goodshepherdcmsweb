    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        ...
        <div class="lg:col-span-2">
          <a href="#" class="flex items-center gap-3" @click="scrollTo($event, '#')">
            <img
              ...
              class="h-8 w-auto"
            />
            <span class="font-serif text-xl font-semibold text-slate-900 tracking-tight">
              Good Shepherd Assemblies of God
            </span>
          </a>
          <p class="mt-4 text-slate-600 leading-relaxed max-w-md">
            A Spirit-empowered Pentecostal church dedicated to evangelizing
            the lost, worshiping God, and making disciples of all nations.
          </p>
        </div>
        ...
        <div>
          ...
          <address class="mt-4 text-slate-600 not-italic leading-relaxed">
            Kronum, Kwapra, Carpentermu<br />
            Kumasi, Ghana
          </address>
          <p class="mt-4 text-slate-600">
            <span class="font-medium text-slate-900">Sunday Service:</span><br />
            7:00 AM & 10:00 AM
          </p>
          <p class="mt-4 text-slate-600">
            <span class="font-medium text-slate-900">Phone:</span><br />
            +233 000 000 0000
          </p>
        </div>
        ...
        <!-- Social Links -->
        <div>
          <h3 class="font-semibold text-slate-900">Connect</h3>
          ...
          <p class="mt-6 text-slate-600">info@goodshepherdag.org</p>
        </div>
      </div>

      <!-- Copyright -->
      <div class="mt-12 pt-8 border-t border-slate-200 text-center text-slate-500 text-sm">
        <p>&copy; 2026 Good Shepherd Assemblies of God. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
